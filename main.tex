...
which measures the extent to which the antecedent item, $I$, implies the consequent item, $j$. If the confidence of the association rule [\#billieeilish $\rightarrow$ \#edit] is 0.80, then 80\% of all purchases containing diapers also contain milk. This is a general measure of how strongly associated these two items are. Another measure to consider is lift, which is defined as follows:
\begin{center}
$lift(I \rightarrow j) =  \frac{conf(I \rightarrow j)}{(P(j)}$
\end{center}
which is the ratio that measures the magnitude to which $I$ amplifies or “lifts” the likelihood of $j$. If the lift of [\#billieeilish $\rightarrow$ \#edit] is 2.5, then milk is 2.5 times as likely to be purchased if diapers are also purchased.
\begin{figure}
\begin{adjustwidth}{-2cm}{-2cm} % Adjust margins: left and right
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[width=0.5\linewidth]{viz/great_table_itemset_stats.png}
        \captionsetup{width=0.9\linewidth, justification=centering} 
...
When glancing over exploratory data analysis in Figure \ref{great_table_itemset_stats}, it appears that Harris’s followers have a richer and larger corpus of TikTok repost hashtags. Despite there being fewer Harris followers in the dataset, there are roughly three times as many TikTok videos reposted by the Harris followers compared to Trump followers. The Harris follower corpus additionally has more than twice as many unique hashtag tokens compared to the Trump follower corpus, and each repost on average contains more hashtags.

\begin{figure}
\begin{adjustwidth}{-2cm}{-2cm}
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[height=6in]{viz/gt_kamala_association_rules.png}\includegraphics[height=6in]{viz/gt_trump_association_rules.png}
        \captionsetup{width=0.9\linewidth, justification=centering} 
...
Looking to Figure \ref{high_confidence_rule}, we begin to see emergent patterns of the most closely related hashtags.
