...
RQ 2: Of the TikTok users who followed official TikTok campaign accounts, what are the network structures of co-occurring hashtags in the TikTok posts that were reposted by those followers, and how do they compare with each other?
...
\begin{table}[h]    
    \begin{tblr}{
        ...
        Harris High Centrality Nodes & & & & & & Trump High Centrality Nodes & & & & & \\
        
    \end{tblr}
    \captionsetup{justification=centering}
    \caption{Hashtags with high centrality in the Harris and Trump co-occurrence networks displayed on the left and right, respectively.}
    \label{high_centrality_nodes}
\end{table}
