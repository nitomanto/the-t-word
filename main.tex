...
\newcommand{\keywords}{social media, TikTok, politics, partisan, election, culture, social network analysis, frequent itemset mining, association rule mining, topic modeling}
...
My analysis of TikTok reposts indicate several crucial findings. Firstly, Harris followers repost more frequently and richly compared to Trump followers; in addition to a higher average number of reposts, Harris reposts have a higher average number of hashtags per repost. Secondly, Trump followers have denser and higher connectivity semantic communities than Harris followers. Finally, the difference in content between Harris and Trump follower reposts reveal some interesting cultural patterns. In the following sections, I show an in-depth examination for each of my analysis methods.
...
\begin{table}[!htbp]
    ...
    \begin{tblr}{
        ...
        Avg Hashtags per Repost      &4.82          &4.64
    \end{tblr}
