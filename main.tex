...
which measures the extent to which the antecedent item, $I$, implies the consequent item, $j$. If the confidence of the association rule [\#billieeilish $\rightarrow$ \#edit] is 0.80, then 80\% of all  also contain milk. This is a general measure of how strongly associated these two items are. Another measure to consider is lift, which is defined as follows:
\begin{center}
